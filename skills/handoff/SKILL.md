...
Forward them verbatim to the script. The entry point is a thin shim that exec's into `python -m pipeline.cli handoff`; the handoff agent lives in `pipeline/handoff.py`:
