...
When the user signals they're ready to build — "looks good", "let's implement it", "ghimplement it", "localimplement", "hand off", or similar — offer the two targets and invoke whichever they pick, passing the spec path as the instructions argument via the Skill tool:
...
Invocation:
- `Skill(skill="localimplement", args="/tmp/design-<slug>.md")`
- `Skill(skill="ghimplement", args="/tmp/design-<slug>.md")`
